#ifndef BBRTC_MEDIA_ENGINE_H
#define BBRTC_MEDIA_ENGINE_H
#include <stdint.h>
...
class IAudioFrameObserver {
 ...
 public:
   ...
   * Bbrtc recommends that you
   * call \ref bbrtc::rtc::IRtcEngine::setRecordingAudioFrameParameters "setRecordingAudioFrameParameters"
   ...
   *
   * @note To ensure that the audio playback frame has the expected format, Bbrtc
   * recommends that you call \ref bbrtc::rtc::IRtcEngine::setPlaybackAudioFrameParameters "setPlaybackAudioFrameParameters"
   * after calling \ref IMediaEngine::registerAudioFrameObserver "registerAudioFrameObserver" to
   ...
   * expected format, Bbrtc recommends that you call
   * \ref bbrtc::rtc::IRtcEngine::setMixedAudioFrameParameters "setMixedAudioFrameParameters"
   * after calling \ref IMediaEngine::registerAudioFrameObserver "registerAudioFrameObserver" to
  ...
  /** Determines whether to receive audio data from multiple channels.
   ...
   In the multi-channel scenario, Bbrtc recommends setting the return value as true.
...
class IVideoFrameObserver {
 ...
 public:
  ...
  /** Determines whether to receive video data from multiple channels.
   ...
   send the video frame. \ref IVideoFrameObserver::onRenderVideoFrame "onRenderVideoFrame" will not be triggered. In the multi-channel scenario, Bbrtc recommends setting the return value as true.
...
class IExternalVideoRenderCallback {
 public:
  virtual ~IExternalVideoRenderCallback(){}
...
struct ExternalVideoRenerContext {
   ...
   */
  void* view;
  /** Video display mode: \ref bbrtc::rtc::RENDER_MODE_TYPE "RENDER_MODE_TYPE" */
  int renderMode;
...
class IMediaEngine {
 public:
  ...
  /** Registers an audio frame observer object.
   ...
   audio observer object. Bbrtc recommends calling `registerAudioFrameObserver(NULL)` after receiving the \ref bbrtc::rtc::IRtcEngineEventHandler::onLeaveChannel "onLeaveChannel" callback.
  ...
  /** **DEPRECATED** Use \ref bbrtc::media::IMediaEngine::pushAudioFrame(IAudioFrameObserver::AudioFrame* frame) "pushAudioFrame(IAudioFrameObserver::AudioFrame* frame)" instead.
   ...
   * \ref bbrtc::rtc::IRtcEngine::setExternalAudioSink
   ...
   * - Once you call the \ref bbrtc::media::IMediaEngine::pullAudioFrame
   * "pullAudioFrame" method successfully, the app will not get any audio
   * data from the
   * \ref bbrtc::media::IAudioFrameObserver::onPlaybackAudioFrame
   * "onPlaybackAudioFrame" callback.
   * - The difference between the
   * \ref bbrtc::media::IAudioFrameObserver::onPlaybackAudioFrame
   * "onPlaybackAudioFrame" callback and the
   * \ref bbrtc::media::IMediaEngine::pullAudioFrame "pullAudioFrame" method is as
   * follows:
  ...
  */
  ...
  /** Pushes the video frame using the \ref ExternalVideoFrame "ExternalVideoFrame" and passes the video frame to the Bbrtc SDK.
