...
Control* WindowBuilder::CreateControlByClass(const std::wstring& strControlClass)
{
	...
	case 5:
		...
		else if (strControlClass == DUI_CTR_VHBOX)              pControl = new VHBox;
		break;
	case 6:
	...
	case 8:
		...
		else if (strControlClass == DUI_CTR_MEDIAWND)           pControl = new MediaWnd;
		break;
	case 9:
		...
		else if (strControlClass == DUI_CTR_VHLISTBOX)          pControl = new ListBox(new VHLayout);
		break;
	case 10:
