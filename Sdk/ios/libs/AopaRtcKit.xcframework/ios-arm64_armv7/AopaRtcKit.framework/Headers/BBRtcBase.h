...
enum WARN_CODE_TYPE {
  ...
  /** **DEPRECATED** 105: The server rejects the request to look up the channel.
   ...
   \ref bbrtc::rtc::IRtcEngineEventHandler::onConnectionStateChanged
   ...
   * remote user exceed 640 &times; 480.
   */
  ...
  /** 3000: Pull stream url expired
   */
  WRAN_PULL_STREAM_URL_EXPIRED = 3000
};
...
enum ERROR_CODE_TYPE {
   ...
   * the channel, for example, \ref bbrtc::rtc::IRtcEngine::joinChannel
   * "joinChannel".
   */
  ...
  /** 18: The request to leave the channel is rejected.
   ...
   bbrtc::rtc::IRtcEngine::leaveChannel "leaveChannel" to leave the channel. In
   this case, stop calling \ref bbrtc::rtc::IRtcEngine::leaveChannel
   "leaveChannel".
  ...
  /** **DEPRECATED** 109: Deprecated as of v2.4.1. Use
   ...
   bbrtc::rtc::IRtcEngineEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback instead.
   ...
   seconds elapsed since 1/1/1970. The user can use the Token to access the
   Bbrtc service within five minutes after the Token is generated. If the user
   does not access the Bbrtc service after five minutes, this Token is no longer
   valid.
   - Call Expiration Timestamp expired: The timestamp is the exact time when a
   user can no longer use the Bbrtc service (for example, when a user is forced
  ...
  /** **DEPRECATED** 110: Deprecated as of v2.4.1. Use
   ...
   \ref bbrtc::rtc::IRtcEngine::joinChannel "joinChannel" method.
   */
  ERR_INVALID_TOKEN = 110,
  /** 111: The internet connection is interrupted. This applies to the Bbrtc Web
   * SDK only.
   */
  ERR_CONNECTION_INTERRUPTED = 111,  // only used in web sdk
  /** 112: The internet connection is lost. This applies to the Bbrtc Web SDK
   * only.
   */
  ERR_CONNECTION_LOST = 112,  // only used in web sdk
  /** 113: The user is not in the channel when calling the \ref
   * bbrtc::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage" or \ref
   * bbrtc::rtc::IRtcEngine::getUserInfoByUserAccount "getUserInfoByUserAccount"
   * method.
   */
  ERR_NOT_IN_CHANNEL = 113,
  /** 114: The size of the sent data is over 1024 bytes when the user calls the
   * \ref bbrtc::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage" method.
   */
  ERR_SIZE_TOO_LARGE = 114,
  /** 115: The bitrate of the sent data exceeds the limit of 6 Kbps when the
   * user calls the \ref bbrtc::rtc::IRtcEngine::sendStreamMessage
   * "sendStreamMessage" method.
   */
  ERR_BITRATE_LIMIT = 115,
  /** 116: Too many data streams (over 5 streams) are created when the user
   * calls the \ref bbrtc::rtc::IRtcEngine::createDataStream "createDataStream"
   * method.
   */
   ...
   * bbrtc::rtc::IRtcEngine::addPublishStreamUrl "addPublishStreamUrl" method
   ...
   * by calling the \ref bbrtc::rtc::IRtcEngine::removePublishStreamUrl
   * "removePublishStreamUrl" and \ref
   * bbrtc::rtc::IRtcEngine::addPublishStreamUrl "addPublishStreamUrl" methods.
   */
  ...
  /** 154: An error occurs in Bbrtc's streaming server. Call the
  ...
  /** **DEPRECATED** 1003: Fails to start the camera.
   ...
   the \ref bbrtc::rtc::IRtcEngineEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback instead.
   */
  ...
  /** **DEPRECATED** 1502: Video Device Module: The camera in use.
   ...
   Deprecated as of v2.4.1. Use LOCAL_VIDEO_STREAM_ERROR_DEVICE_BUSY(3) in the
   \ref bbrtc::rtc::IRtcEngineEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback instead.
   */
